Reporte de Implementación DevOps
...
Visualización: El comando kubectl rollout status garantiza que el microservicio esté disponible. Si este comando falla (debido a errores o indisponibilidad), el pipeline se detiene automáticamente, notificando el error en tiempo real.
...
"Personalmente, fue un proceso de mucho aprendizaje. Lo que más me llevó tiempo fue a no frustrarme con la configuración del cluster, sobre todo cuando el pipeline daba error. Fue un desafío constante entender el proceso completo y cómo se despliega en AWS."
